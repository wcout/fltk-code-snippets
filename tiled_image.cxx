...
int main(int argc, char **argv) {
   fl_register_images();
//	Fl_RGB_Image::scaling_algorithm(FL_RGB_SCALING_BILINEAR);
	Fl_RGB_Image::scaling_algorithm(FL_RGB_SCALING_NEAREST);
#ifdef FLTK_USE_X11
  int i = 1;
...
//  group.image(new Fl_Tiled_Image(new Fl_Pixmap((const char * const *)tile_xpm)));
  group.image(new Fl_Tiled_Image(Fl_Shared_Image::get(argc > 1 ? argv[1] : "tile.png")));
